...
状态：Core 测试基线、Codex/Claude Code/OpenCode/TraeX adapter L0/L1 gate，以及 Codex/Claude/TraeX SessionStart 与 OpenCode session.created real-agent canary 已实现；完整 real-agent matrix 尚未启用。
