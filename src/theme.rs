...
pub struct Semantics {
    ...
    pub md_heading: RawColor,
    pub md_strong: RawColor,
    pub md_emphasis: RawColor,
    pub md_code: RawColor,
    pub md_code_block: RawColor,
    pub md_link: RawColor,
    pub md_quote: RawColor,
    pub md_list_marker: RawColor,
    pub md_rule: RawColor,
    pub md_raw: RawColor,
    // Interactive.
...
impl Semantics {
    ...
    pub fn set(&mut self, name: &str, color: RawColor) -> bool {
        let slot = match name {
            ...
            "md_heading" => &mut self.md_heading,
            "md_strong" => &mut self.md_strong,
            "md_emphasis" => &mut self.md_emphasis,
            "md_code" => &mut self.md_code,
            "md_code_block" => &mut self.md_code_block,
            "md_link" => &mut self.md_link,
            "md_quote" => &mut self.md_quote,
            "md_list_marker" => &mut self.md_list_marker,
            "md_rule" => &mut self.md_rule,
            "md_raw" => &mut self.md_raw,
    ...
    pub fn get(&self, name: &str) -> Option<RawColor> {
        Some(match name {
            ...
            "md_strong" => self.md_strong,
            "md_emphasis" => self.md_emphasis,
            "md_code" => self.md_code,
            "md_code_block" => self.md_code_block,
            "md_link" => self.md_link,
            "md_quote" => self.md_quote,
            "md_list_marker" => self.md_list_marker,
            "md_rule" => self.md_rule,
            "md_raw" => self.md_raw,
    ...
    pub fn resolve(&self, mode: ColorMode) -> Theme {
        ...
        Theme {
            ...
            surface_hover: c(&self.surface_hover),
            dir: c(&self.dir),
            file: c(&self.file),
            ...
            md_heading: c(&self.md_heading),
            md_strong: c(&self.md_strong),
            md_emphasis: c(&self.md_emphasis),
            md_code: c(&self.md_code),
            md_code_block: c(&self.md_code_block),
            md_link: c(&self.md_link),
            md_quote: c(&self.md_quote),
            md_list_marker: c(&self.md_list_marker),
            md_rule: c(&self.md_rule),
            md_raw: c(&self.md_raw),
