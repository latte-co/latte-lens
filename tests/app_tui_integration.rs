...
fn non_git_workspace_lists_clean_and_dirty_descendant_repositories() {
    ...
    for (label, should_be_dirty) in [("clean", false), ("dirty", true)] {
        ...
        if should_be_dirty {
            ...
            assert_eq!(marker.fg, Color::Rgb(209, 154, 102));
        } else {
...
fn visual_focus_cues_identify_tabs_tree_and_content_without_backgrounds() {
    ...
    assert_eq!(tree_heading.fg, Color::Rgb(97, 175, 239));
    ...
    assert_eq!(content_heading.fg, Color::Rgb(160, 137, 255));
...
fn all_files_uses_a_small_aligned_change_gutter() {
    ...
    assert_eq!(directory_hint.fg, Color::Rgb(209, 154, 102));
    ...
    assert_eq!(file_hint.fg, Color::Rgb(209, 154, 102));
...
fn default_diff_content_can_be_mouse_selected_and_copied() {
    ...
    assert_eq!(deleted_number.fg, Color::Rgb(224, 108, 117));
    ...
    assert_eq!(added_number.fg, Color::Rgb(152, 195, 121));
    ...
    assert_eq!(added_marker.fg, Color::Rgb(152, 195, 121));
